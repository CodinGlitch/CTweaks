...
@OnlyIn(Dist.CLIENT)
public class FoxHeldItemLayerModified extends LayerRenderer<FoxEntityModified, FoxModelModified<FoxEntityModified>> {
    public FoxHeldItemLayerModified(IEntityRenderer<FoxEntityModified, FoxModelModified<FoxEntityModified>> p_i50938_1_) {
        super(p_i50938_1_);
    }

    public void render(MatrixStack p_225628_1_, IRenderTypeBuffer p_225628_2_, int p_225628_3_, FoxEntityModified p_225628_4_, float p_225628_5_, float p_225628_6_, float p_225628_7_, float p_225628_8_, float p_225628_9_, float p_225628_10_) {
