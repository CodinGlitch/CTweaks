package com.codinglitch.ctweaks.client.model;
...
public class FoxModelModified<T extends FoxEntityModified> extends AgeableListModel<T> {
    ...
    public void prepareMobModel(T p_212843_1_, float p_212843_2_, float p_212843_3_, float p_212843_4_) {
        ...
        this.leg0.xRot = Mth.cos(p_212843_2_ * 0.6662F) * 1.4F * p_212843_3_;
        this.leg1.xRot = Mth.cos(p_212843_2_ * 0.6662F + (float)Math.PI) * 1.4F * p_212843_3_;
        this.leg2.xRot = Mth.cos(p_212843_2_ * 0.6662F + (float)Math.PI) * 1.4F * p_212843_3_;
        this.leg3.xRot = Mth.cos(p_212843_2_ * 0.6662F) * 1.4F * p_212843_3_;
        this.head.setPos(-1.0F, 16.5F, -3.0F);
        this.head.yRot = 0.0F;
    ...
    public void setupAnim(T p_225597_1_, float p_225597_2_, float p_225597_3_, float p_225597_4_, float p_225597_5_, float p_225597_6_) {
        ...
        if (p_225597_1_.isSleeping()) {
            this.head.xRot = 0.0F;
            this.head.yRot = -2.0943952F;
            this.head.zRot = Mth.cos(p_225597_4_ * 0.027F) / 22.0F;
        }

        if (p_225597_1_.isCrouching()) {
            float f = Mth.cos(p_225597_4_) * 0.01F;
            this.body.yRot = f;
            this.leg0.zRot = f;
            this.leg1.zRot = f;
